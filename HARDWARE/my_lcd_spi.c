...
{
    u8 i;
    for(i=0;i<sizeof(Pins_LCD_ILI9341)/sizeof(MyPinDef);i++)
    {
#if !defined (USE_HAL_DRIVER)
        GPIO_Pin_Init(Pins_LCD_ILI9341[i],GPIO_Mode_Out_PP);
#else
        GPIO_Pin_Init(Pins_LCD_ILI9341[i],GPIO_MODE_OUTPUT_PP,GPIO_PULLUP);
#endif
    }
}
/*****************************************************************************
